...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Dialog container */}
      <div
        className={`relative w-full ${maxWidthMap[maxWidth]} rounded-2xl border border-slate-700/80 bg-slate-900 shadow-2xl transition-all z-10 my-8 overflow-hidden`}
      >
        {/* Header */}
